...
public class popUpMessages {
    ...
    init() {
        ...
        popUpTitle.updateValue("Hip", forKey: "Hip")
        popUpTitle.updateValue("leftArm", forKey: "leftArm")
        popUpTitle.updateValue("Spine", forKey: "spine")
        popUpTitle.updateValue("rightArm", forKey: "rightArm")
        ...
        popUpDict.updateValue("Evidence for bipedality: The pelvis is wide and bowl-shaped, as it is in humans.", forKey: "Hip")
        popUpDict.updateValue("Australopithecus afarensis lived in east Africa 3.9-2.9 million years ago in mosaic habitats of open woodland, grassland and shrubland", forKey: "leftArm")
        ...
        popUpDict.updateValue("Lucy was discovered in exposed sediments in Hadar, Ethiopia. Additional fossils belonging to her species have also been found in othe sides in Ethiopia, Kenya and Tanzania.", forKey: "rightArm")
